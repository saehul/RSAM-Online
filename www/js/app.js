...
const nama_instansi = 'RSUD AWET MUDA Narmada'; // Hospital Name
const apiUrl = 'http://36.94.45.33/rsam-online/pasien-rest/'; // API Server URL
...
var app  = new Framework7({
  ...
  id: 'com.rsam.apam', // App bundle ID
  name: 'RSAM Online', // App name
  dialog: {
    title: 'Peringatan',
    buttonOk: 'Ya',
    buttonCancel: 'Tidak'
...
if (debug == '1') {
  ...
  function appReady(){
    ...
    document.addEventListener('resume', function(){
      ga('send', 'pageview' , {'location' : 'http://36.94.45.33/pasien-rest/index.html' });
    }, false);
  ...
  app.request.post(apiUrl + 'api.php', {
    ...
    if(data.state == "notifbooking") {
      ...
      app.notification.create({
        ...
        subtitle: 'RSUD Awet Muda Narmada',
  ...
  app.request.post(apiUrl + 'api.php', {
    ...
    if(data.state == "notifberkas") {
      ...
      app.notification.create({
        ...
        titleRightText: 'saat ini',
        subtitle: 'RSUD Awet Muda Narmada',
        text: '<b>'+ stts +'</b>. Silahkan menuju ke Klinik pilihan anda di RSUD Awet Muda Narmada untuk mendapatkan layanan prioritas tanpa harus antri di loket pendaftaran.',
        closeButton: true,
        closeOnClick: true,
        on: {
          close: function () {
